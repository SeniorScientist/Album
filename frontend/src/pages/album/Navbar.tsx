...
import DropdownMenu, { IMenuOption } from '../../components/dropdown-menu/dropdown-menu'
...
export default function Navbar() {
  ...
  const [navigation, setNavigation] = useState([
    { name: 'Dashboard', href: PathConstants.DASHBOARD, current: false },
    { name: 'Upload', href: PathConstants.UPLOAD, current: false },
  ])
  ...
  const menuOptions: Array<IMenuOption> = [
    {
      icon: <FaEdit />,
      label: 'Edit Profile',
      onClick: () => navigate(PathConstants.UPDATEPROFILE),
    },
    {
      icon: <FaSignOutAlt />,
      label: 'Log Out',
